...
export const PARSER_PROFILES = {
    ...
    adcb:      { ...BANK_OFFER_PROFILE_BASE, waitSelector: '.offer-card, .promo-card, article' },
    mashreq:   { ...BANK_OFFER_PROFILE_BASE, waitSelector: '.offer-card, .promotion-item, article' },
    rakBank:   { ...BANK_OFFER_PROFILE_BASE, waitSelector: '.offer-card, .card-offer, article' },
    dib:       { ...BANK_OFFER_PROFILE_BASE, waitSelector: '.offer, .promotion, article' },
    hsbc:      { ...BANK_OFFER_PROFILE_BASE, waitSelector: '.offer-card, .promo-card, article' },
    citibank:  { ...BANK_OFFER_PROFILE_BASE, waitSelector: '.offer-card, .promo-item, article' },
    cbd:       { ...BANK_OFFER_PROFILE_BASE, waitSelector: '.offer-card, .deal-card, article' },
