-- Migration 011: Re-tier UAE bank sources for Tier A/B crawl strategy
...
UPDATE sources SET status = 'rejected', rejection_reason = 'coupon_aggregator_demoted'
WHERE source_type = 'groupon' AND status != 'rejected';

-- Purge known noise offers from previous crawls
